<div class="post">
    <div class="post_user">
        <div class="post_user_logo">
            <a href="{{route('getUserArticles',['id'=>$article->user->id,'statistic_name'=>'articles'])}}"><img src="{{Storage::url($article->user->photo)}}"></a>
        </div>
        <div class="post_user_name">
            <a href="{{route('getUserArticles',['id'=>$article->user->id,'statistic_name'=>'articles'])}}">{{$article->user->name}}</a>
        </div>
    ...
    <div class="post_statistic">
        ...
        <div> <!-- Сохранить -->
            ...
            @if (\App\Models\Favorites::where('article_id', '=', $article->id)->where('user_id', $_SESSION['user']['id'])->exists())
                addedFavorites
@endif
            @endif
                " viewBox="0 0 16 16">
